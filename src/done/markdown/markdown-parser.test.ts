...
describe('Markdown Parser', () => {
    ...
    describe('HEADER_RULE', () => {
        ...
        it('should convert ### through ###### to p tags', () => {
            expect(parseRichText('### H3', RICH_TEXT_RULES)).toContain('<p>H3</p>');
            expect(parseRichText('#### H4', RICH_TEXT_RULES)).toContain('<p>H4</p>');
            expect(parseRichText('##### H5', RICH_TEXT_RULES)).toContain('<p>H5</p>');
